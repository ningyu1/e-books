...
# 目录
* [行业信息](#hangye)
* [CNUTCon上海2018](#cnutcon2018)
	* [AIOps实践与探索](#cnutcon2018_1)
	* [自动化运维平台实践](#cnutcon2018_2)
	* [监控与分析（APM）](#cnutcon2018_3)
	* [日志处理](#cnutcon2018_4)
	* [大规模系统的性能优化](#cnutcon2018_5)
	* [智能+时代下的运维破局](#cnutcon2018_6)
	* [数据库运维](#cnutcon2018_7)
	* [CI/CD实践](#cnutcon2018_8)
	* [微服务架构与实践](#cnutcon2018_9)
	* [Kubernetes实战](#cnutcon2018_10)
	* [SRE实践与思考](#cnutcon2018_11)
	* [主题演讲](#cnutcon2018_12)
	* [解决方案专场（厂商共建专场）](#cnutcon2018_13)
...
# <span id="cnutcon2018">CNUTCon上海2018</span>

## <span id="cnutcon2018_1">AIOps实践与探索</span>
* [百度变更发布检查从人工到智能进阶](doc/cnutcon2018/百度变更发布从人工到智能进阶.pdf)
* [高效智能故障处理中的系统工程](doc/cnutcon2018/智能故障处理中的系统工程.pdf)

## <span id="cnutcon2018_2">自动化运维平台实践</span>
* [美丽联合集团一站式自助运维平台实践之路](doc/cnutcon2018/美丽联合集团一站式自助运维平台实践之路.pdf)
* [微博平台自动化运维实践](doc/cnutcon2018/微博平台自动化运维实践.pdf)
* [小米弹性调度平台：从PaaS到DCOS](doc/cnutcon2018/小米弹性调度平台-从PaaS到DCOS.pdf)

## <span id="cnutcon2018_3">监控与分析（APM）</span>
* [全链路监控系统（鹰眼）在阿里巴巴的技术实践](doc/cnutcon2018/全链路监控系统鹰眼在阿里巴巴的技术实践.pdf)
* [百度云报警通告系统的下一幕](doc/cnutcon2018/百度云报警通告系统的下一幕.pdf)
* [去哪儿网监控报警平台的设计和演化](doc/cnutcon2018/去哪儿网监控报警平台的设计和演化.pdf)
* [ApacheSkyWalking-V6.0可定制开源APM](doc/cnutcon2018/ApacheSkyWalking-V6.0可定制开源APM.pdf)

## <span id="cnutcon2018_4">日志处理</span>
* [新思路打造移动端个案综合日志分析系统](doc/cnutcon2018/新思路打造移动端个案综合日志分析系统.pdf)
* [QA与Ops通力合作打造反脆弱的软件系统](doc/cnutcon2018/QA与Ops通力合作打造反脆弱的软件系统.pdf)

## <span id="cnutcon2018_5">大规模系统的性能优化</span>
* [基于CPU的深度学习推理优化部署方案和实践](doc/cnutcon2018/基于CPU的深度学习推理优化部署方案和实践.pdf)
* [华为云DevCloud的网站优化实践](doc/cnutcon2018/华为云DevCloud的网站优化实践.pdf)

## <span id="cnutcon2018_6">智能+时代下的运维破局</span>
* [2018加速度-全球DevOps现状调查报告](doc/cnutcon2018/2018加速度-全球DevOps现状调查报告.pdf)
* [针对游戏经济系统异常的智能化监控实战](doc/cnutcon2018/针对游戏经济系统异常的智能化监控实战.pdf)

## <span id="cnutcon2018_7">数据库运维</span>
* [阿里巴巴数据库运维发展与实践](doc/cnutcon2018/阿里巴巴数据库运维发展与实践.pdf)

## <span id="cnutcon2018_8">CI/CD实践</span>
* [CI-CD中高效测试基础架构的建设与实践](doc/cnutcon2018/CI-CD中高效测试基础架构的建设与实践.pdf)
* [CloudNative-CI-CD探索](doc/cnutcon2018/CloudNative-CI-CD探索.pdf)
* [小米研发效能演进之路](doc/cnutcon2018/小米研发效能演进之路.pdf)
* [携程的容器化交付实践](doc/cnutcon2018/携程的容器化交付实践.pdf)

## <span id="cnutcon2018_9">微服务架构与实践</span>
* [拥抱ServiceMesh-传统微服务框架的技术演进之路](doc/cnutcon2018/拥抱ServiceMesh-传统微服务框架的技术演进之路.pdf)
...
* [七牛存储运维实践](doc/cnutcon2018/七牛存储运维实践.pdf)
* [支撑百亿请求的微博广告运维技术实践](doc/cnutcon2018/支撑百亿请求的微博广告运维技术实践.pdf)

## <span id="cnutcon2018_12">主题演讲</span>
* [容器时代的全球游戏运维](doc/cnutcon2018/容器时代的全球游戏运维.pdf)
* [运维AI时代-百度如何构建AIOps体系](doc/cnutcon2018/运维AI时代-百度如何构建AIOps体系.pdf)
* [阿里巴巴智能化运维建设之道](doc/cnutcon2018/阿里巴巴智能化运维建设之道.pdf)

## <span id="cnutcon2018_13">解决方案专场（厂商共建专场）</span>
* [Istio在FreeWheel微服务中的实践](doc/cnutcon2018/Istio在FreeWheel微服务中的实践.pdf)
* [混合云发展趋势与多活架构设计探索](doc/cnutcon2018/混合云发展趋势与多活架构设计探索.pdf)
* [基于k8s开发高可靠数据库服务的实践](doc/cnutcon2018/基于k8s开发高可靠数据库服务的实践.pdf)
...
* [区块链技术指南.pdf](doc/区块链技术指南.pdf)
* [区块链应用场景.docx](doc/区块链应用场景.docx)
* [比特币开发者指南-中文版.pdf](doc/比特币开发者指南-中文版.pdf)
